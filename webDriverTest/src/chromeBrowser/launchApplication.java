...
public class launchApplication {
	...
	public static void main(String[] args) {
		// Sets driver/ tells what driver needs to be loaded (For PC)
		...
		// Sets driver/ tells what driver needs to be loaded (For Mac)
		System.setProperty("webdriver.chrome.driver", "Mackintosh HD\\Users\\stevenjr.\\Downloads\\chromedriver_mac64/chromedriver.exe");
		WebDriver driver = new ChromeDriver();		
